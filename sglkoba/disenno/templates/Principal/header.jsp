...
<table width="100%" border="0" align="center" cellpadding="0"
	...
	<tr>
		<td colspan="2">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td width="20%"><% if (miPuerto != null && !miPuerto.equals("9091")) { %><img src="./disenno/templates/Principal/images/index/logo.gif" width="100%" height="auto"><%} %>
					<td align="left">
	...
	<tr>
		<td colspan="2"><% if (miPuerto != null && !miPuerto.equals("9091")) { %><img src="./disenno/templates/Principal/images/index/ktopbar.gif" width="10%" height="auto"> <%} %></td>
	</tr>
	<tr>
		<td colspan="2">
