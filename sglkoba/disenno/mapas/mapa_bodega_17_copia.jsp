...
<table width="715" cellpadding="0"  cellspacing="0"  border="1" bordercolor="#000000" >
            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="0">
              ...
              <tr> 
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabla_mapa">
                    <TR>
                     <% /*<td colspan="10" align="center"> ZONA DE DESCARGUE</td>*/%>
 ...
 <tr> 
			  ...
			  <tr> 
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabla_mapa">
                     <tr> 
                      <td>26</td>
              ...
              <tr> 
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabla_mapa">
                    <tr> 
                      <td>47</td>
                      <td><a href="javascript:pick('A47')"><img src="./disenno/mapas/pixel<%= getpixel("A47" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('B47')"><img src="./disenno/mapas/pixel<%= getpixel("B47" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('C47')"><img src="./disenno/mapas/pixel<%= getpixel("C47" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('D47')"><img src="./disenno/mapas/pixel<%= getpixel("D47" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('E47')"><img src="./disenno/mapas/pixel<%= getpixel("E47" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('F47')"><img src="./disenno/mapas/pixel<%= getpixel("F47" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('G47')"><img src="./disenno/mapas/pixel<%= getpixel("G47" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('H47')"><img src="./disenno/mapas/pixel<%= getpixel("H47" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('I47')"><img src="./disenno/mapas/pixel<%= getpixel("I47" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                    </tr>
					                    <tr> 
                      <td>48</td>
                      <td><a href="javascript:pick('A48')"><img src="./disenno/mapas/pixel<%= getpixel("A48" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('B48')"><img src="./disenno/mapas/pixel<%= getpixel("B48" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('C48')"><img src="./disenno/mapas/pixel<%= getpixel("C48" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('D48')"><img src="./disenno/mapas/pixel<%= getpixel("D48" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('E48')"><img src="./disenno/mapas/pixel<%= getpixel("E48" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('F48')"><img src="./disenno/mapas/pixel<%= getpixel("F48" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('G48')"><img src="./disenno/mapas/pixel<%= getpixel("G48" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('H48')"><img src="./disenno/mapas/pixel<%= getpixel("H48" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('I48')"><img src="./disenno/mapas/pixel<%= getpixel("I48" , posiciones, tipo)  %>.gif" width="47" height="15" border="0"></a></td>
                    </tr>
              ...
              <tr> 
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabla_mapa">
                    <tr> 
                      <td>49</td>
                      <td><a href="javascript:pick('A49')"><img src="./disenno/mapas/pixel<%= getpixel("A49" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('B49')"><img src="./disenno/mapas/pixel<%= getpixel("B49" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('C49')"><img src="./disenno/mapas/pixel<%= getpixel("C49" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('D49')"><img src="./disenno/mapas/pixel<%= getpixel("D49" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('E49')"><img src="./disenno/mapas/pixel<%= getpixel("E49" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('F49')"><img src="./disenno/mapas/pixel<%= getpixel("F49" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('G49')"><img src="./disenno/mapas/pixel<%= getpixel("G49" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('H49')"><img src="./disenno/mapas/pixel<%= getpixel("H49" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('I49')"><img src="./disenno/mapas/pixel<%= getpixel("I49" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                    </tr>
					                    <tr> 
                      <td>50</td>
                      <td><a href="javascript:pick('A50')"><img src="./disenno/mapas/pixel<%= getpixel("A50" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('B50')"><img src="./disenno/mapas/pixel<%= getpixel("B50" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('C50')"><img src="./disenno/mapas/pixel<%= getpixel("C50" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('D50')"><img src="./disenno/mapas/pixel<%= getpixel("D50" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('E50')"><img src="./disenno/mapas/pixel<%= getpixel("E50" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('F50')"><img src="./disenno/mapas/pixel<%= getpixel("F50" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('G50')"><img src="./disenno/mapas/pixel<%= getpixel("G50" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('H50')"><img src="./disenno/mapas/pixel<%= getpixel("H50" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                      <td><a href="javascript:pick('I50')"><img src="./disenno/mapas/pixel<%= getpixel("I50" , posiciones, tipo)  %>.gif" width="49" height="15" border="0"></a></td>
                    </tr>
