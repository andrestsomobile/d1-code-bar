...
<div class="titulo"> Generacion Reporte de Despachos (Excel)</div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=reporte_despachos_excel&tipo_reporte=EXCELGENERADO" method="post" onsubmit="return validar()"> 
<table >
<%@include file="compania.jsp"%> 
<%@include file="fechas.jsp"%> 
<input type="hidden" name="pagina" value='main.jsp?app=reportes&modulo=reporte_despachos_excel&tipo=operaciones'>  
