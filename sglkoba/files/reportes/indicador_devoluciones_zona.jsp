...
<div class="titulo"> Indicador de Devoluciones por Zona </div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=indicador_devoluciones_zona" method="post" onsubmit="return validar()"> 
<table>
