...
<div class="titulo"> Nacionalizaciones</div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=nacionalizaciones" method="post" onsubmit=" return validar();" > 
<table >
