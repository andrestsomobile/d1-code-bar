...
<div class="titulo"> Reparaciones de Mercancia </div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=reparaciones" method="post" onsubmit="return validar()"> 
<table >
