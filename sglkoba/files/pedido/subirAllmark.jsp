<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import =" pedido.action.*, maestro.control.*, maestro.entity.*; " %>
...
function Guardar()
{
	...
	location.href="subirAllmarkAction.do?ruta="+archivo.value+"&compania="+codcia.value;
}
</script>

<html:form action="reportesAction.do" method="post" onsubmit="return validar()"> 

<div class="titulo"> Interface Allmark </div> 
