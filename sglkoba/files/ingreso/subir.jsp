...
function Guardar()
{
	...
	var trafcodsx=<%=request.getParameter("trafcodsx")%>;
	if(trafcodsx=="")trafcodsx="null";
	location.href="referencia_traficoAction.do?opcion=plano&trafcodsx="+trafcodsx+"&ruta="+archivo.value;
}
</script>
