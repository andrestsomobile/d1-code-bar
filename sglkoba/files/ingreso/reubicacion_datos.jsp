...
//					form.setBodegafin(entfin.getEntbodega());
        ...
        <tr> 
          ...
          <td> <input type="hidden" name="reingreso" > <input type="hidden" name="procodsx" > <input type="text" name="producto" readonly="true" Class="readonly" value="<%= producto %>" > 
          <td>Bodega 
      ...
      <%
				...
				String[] parametros = new String[] {  tipo,cia,   "0", ""};
				String[] parametros_total = new String[] {tipo,cia, ""};
				String[] campos_form= new String[] {"reentradaor","procodsx" ,"producto", "productofin", "bodega", "posicion", "saldo","reingreso"};
				String[] campos_pick = new String[] {"entcodsx", "entcantidad", "entcodingreso", "entcodingreso","Entbodega", "entposicion", "entsaldosinnac","entpesoneto"};
				String[] campos_entity= new String[] { "entcodingreso", "entcodproducto", "Entbodega", "entposicion", "entsaldosinnac", "entpesoneto"};
				String[] nombres_campos_entity= new String[] {"Material" , "Descripcion", "Bodega", "Posicion", "Saldo"};
				String formulario = "reubicacionForm"; 
				String metodo = "getlistaentradaByTipo"; 
				String metodoTotal = "getTotalPaginaslistaentradaByTipo";
    ...
    <td><html:hidden property="reentradafin"  /> <table class="pequeno" cellpadding="0" cellspacing="" border="1" width="200">
        <tr> 
          ...
          <td> <%
					...
					request.setAttribute("listabodega", gbod.getlistaBodegasConConfig());
					if(reubic==null) {
        ...
        <tr> 
		  ...
		  <input type="text" list="items" name="posicionfin" value="">
		  <!-- Lista de opciones -->
		  <datalist id="items">
