...
function Guardar()
{
	var trafico=document.getElementsByName("compania")[0].value;
	var archivo=document.getElementById("txtFile");
	console.log('trafico' + trafico)
	location.href="actualizarPosicionesAction.do?opcion=plano&ingcodsx="+trafico+"&ruta="+archivo.value;
}
</script>

<html:form action="reportesAction.do" method="post" onsubmit="return validar()"> 
<table >
<tr><%@include file="traficoConsulta.jsp"%></tr>

</table>
</html:form>

	<div class="titulo"> Cargar Posiciones desde un Archivo </div> 
	<br> 
	<table >
	<tr>
		<td><a href="files/ingreso/MODELOCARGARPOSICIONES.xls" download="files/ingreso/MODELOCARGARPOSICIONES.xls">Archivo modelo para cargue de posiciones</a>
	</tr>
</table>
	...
	<p>La estructura es un archivo Excel 97-2003 (.xls). Son 9 columnas</p>
	<p>Los encabezados de las columnas son: MATERIAL/DESCRIPCIÓN/UMP/NUMERO DE IMP/CANTIDAD/BODEGA ACTUAL/POSICION ACTUAL/BODEGA NUEVA/POSICION NUEVA
</p>
