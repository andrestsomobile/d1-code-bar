...
function Guardar()
{
	...
	var ingcodsx=<%=request.getParameter("ingcodsx")%>;
	if(ingcodsx=="")ingcodsx="null";
	location.href="subirPosicionesAction.do?opcion=plano&ingcodsx="+ingcodsx+"&ruta="+archivo.value;
}
</script>
