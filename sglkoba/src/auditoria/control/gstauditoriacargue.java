...
public class gstauditoriacargue extends GstTabla implements java.io.Serializable {
	...
	public Collection getlistaauditoriacargueByActividad(String actividad, String fechainicio, String fechafinal) {
		String cad = "SELECT * FROM auditoriacargue WHERE acactividad = '" + actividad + "' AND acobservacion != 'ELIMINADO' AND acfechainicio BETWEEN '"
				+ fechainicio + "' AND '" + fechafinal + "' ORDER BY acfechainicio DESC";
		return getLista(cad);
	}
	
	public Collection getlistaTopauditoriacargueByActividad(String actividad, String top) {
		String cad = "SELECT * FROM auditoriacargue WHERE acactividad = '" + actividad + "' AND acobservacion != 'ELIMINADO' ORDER BY acfechainicio DESC LIMIT " + top;
		return getLista(cad);
	}
