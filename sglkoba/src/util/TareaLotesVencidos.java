	...
	public void run() {
		...
		try {
			...
			if (arreglo != null && !arreglo.isEmpty()) {
				mensaje = mensaje + "<tr><th>Lote</th><th>Material</th><th>Descripcion</th><th>Saldo Disponible</th><th>Fecha Vencimiento</th></tr>";
	...
	private class gstnotificacionLV extends GstTabla {
		...
		public Collection getlistaVencimientoLotes() {
			String consulta = "select \r\n" + 
					...
					//"||'</td><td>'||sum(coalesce(lctrafcantidad,0.00)) \r\n" + 
