...
public class kardex_categoria extends Command {
	...
	public void execute(String ruta, HttpServletRequest request,
		...
		File reporte = new File(  ruta + "kardex_categoria.jasper");
			

		
		String sql = "select * from reporte_kardex_categoria(" + repfor.getCompania() + "," + repfor.getCategoria() + ",'" +
