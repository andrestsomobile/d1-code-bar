...
<div class="titulo">Ajustes de Ingreso de Mercancia</div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=ingreso_ajuste" method="post" onsubmit="return validar()" > 
<table >
