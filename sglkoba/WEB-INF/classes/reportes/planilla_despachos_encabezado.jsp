...
<div class="titulo"> Planilla de Despachos </div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=planilla_despachos_encabezado" method="post" onsubmit="return validar()"  > 
<table >
