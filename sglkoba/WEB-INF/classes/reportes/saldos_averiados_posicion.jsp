...
<div class="TITULO"> Reportes de Inventario  <br>Saldos Averiados</div>
 <br>
<html:form action="reportesAction.do?tipo=inventarios&reporte=saldos_averiados_posicion" method="post" onsubmit="return validar()" > 
<html:hidden property="reporte" value="saldos_averiados_posicion"/>
<table >
