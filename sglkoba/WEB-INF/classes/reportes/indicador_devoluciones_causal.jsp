...
//valido el cliente:	
	if( document.reportesForm.cliente.value=='') mens +='-Debe Escribir la cliente\n';
...
<div class="titulo"> Indicador de Devoluciones por Causales por Cliente</div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=indicador_devoluciones_causal" method="post" onsubmit="return validar()"> 
<table>
