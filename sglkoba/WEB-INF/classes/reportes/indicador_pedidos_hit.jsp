...
<div class="titulo"> Indicador de Pedidos No HIT </div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=indicador_pedidos_hit" method="post" onsubmit="return validar()"> 
<table>
<%@include file="mes.jsp"%>
<%@include file="hit.jsp"%>
