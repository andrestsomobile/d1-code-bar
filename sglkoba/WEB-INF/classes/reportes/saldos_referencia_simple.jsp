...
<div class="TITULO"> Reportes de Inventario  <br>Saldos por Referencia </div>
 <br>
<html:form action="reportesAction.do?tipo=inventarios&reporte=saldos_referencia_simple" method="post" onsubmit="return validar()" > 
<html:hidden property="reporte" value="saldos_referencia_simple"/>
<table >
