...
<div class="titulo"> Indicador de Pedidos por Zona Con Valores Totalizados</div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=indicador_zonas_valores" method="post" onsubmit="return validar()"> 
<table>
