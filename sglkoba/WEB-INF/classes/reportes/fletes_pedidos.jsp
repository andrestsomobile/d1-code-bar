...
<div class="TITULO"> Fletes de Pedidos </div>
 <br>
<html:form action="reportesAction.do?tipo=operaciones&reporte=fletes_pedidos&tipo_reporte=EXCELGENERADO" method="post" onsubmit="return validar()" > 
<input type="hidden" name="pagina" value='main.jsp?app=reportes&modulo=fletes_pedidos&tipo=operaciones'>
<table >
