...
<div class="titulo"> Historico de movimientos por embarque</div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=historico_embarque" method="post" onsubmit="return validar()" > 
<table >
