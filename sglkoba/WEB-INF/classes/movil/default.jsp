...
<form id="myForm" name="myForm" method='post' action='main_movil.jsp?app=movil&modulo=default'> 	 	
	...
	<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" >
		...
		<tr>
			<td colspan="2"><button id="btnRegistroFotografico" type="button" class="myButton" 
			        onclick='irOpcion(<%=gper.verIzquierdo(grupo, "movil", "registroFotografico.jsp")%>,"registroFotografico", "registroFotografico")'>Recibo de Mercancías: Registro Fotografico Inspeccion</button></td>
