...
%>
<div class="titulo">Cargar Documentos Nacionalizacion: <%=clave%> </div> 
	...
	<form id="myForm" enctype="multipart/form-data" method="post" target="uploadFrame" 
		action="servlet/FileUploadServlet?tipoAdjunto=NACIONALIZACION&ruta_pdf=pdf&clave=<%=request.getParameter("clave")%>" onsubmit="ajaxFunction()">
...
<table border="1" cellpadding="0" cellspacing="0" class="lista-home">
   <caption> Documentos Cargados Nacionalizacion: <%=request.getParameter("clave")%> </caption>
    <tr>
      <th> Archivo 
      <th> Tamaño
      <th> Fecha Creacion
...
a.vClass:link {color: blue;} 
 ...
 <tr>
      ...
      <td nowrap="nowrap"><a href='main.jsp?app=nacionalizacion&modulo=subirAdjuntoNacionalizacion&clave=<%=clave%>&eliminararchivo=ok&nombrearchivo=<%=f.getName() %>'>Eliminar</a>
    </tr>
