...
public class nacionalizacionvehiculo implements java.io.Serializable {
	...
	public nacionalizacionvehiculo(String nvcodsx, String nvfmm, String nvfecha, String nvcodvin, String resumen) {
		super();
