...
<%
	...
	for (int i=1;i<=10;i++) {
		String codpedido = request.getParameter("codpedido"+i);
		System.out.println("adicionar carga a pedido"+i+"-> " +codpedido);
		if (codpedido != null && !codpedido.equals("")&& !codpedido.equals("")) {
...
<script>
			...
			function cargar() {
				...
				var ped1 = $("input[name='codpedido1']").val();
				var ped2 = $("input[name='codpedido2']").val();
				var ped3 = $("input[name='codpedido3']").val();
				var ped4 = $("input[name='codpedido4']").val();
				var ped5 = $("input[name='codpedido5']").val();
				var ped6 = $("input[name='codpedido6']").val();
				var ped7 = $("input[name='codpedido7']").val();
				var ped8 = $("input[name='codpedido8']").val();
				var ped9 = $("input[name='codpedido9']").val();
				var ped10 = $("input[name='codpedido10']").val();
				window.location = window.location.pathname + '?codigoTransp='+transp
				+'&codpedido1='+ped1
				+'&codpedido2='+ped2
				+'&codpedido3='+ped3
				+'&codpedido4='+ped4
...
<!-- 		<input type="text" id="codpedido" name='codpedido'  />   -->
		<table align='center'  width='70%' border='0' cellspacing='0' cellpading='0'  >
			<tr><th colspan='100%'>Digite Pedidos</th></tr>
		    <tr>
		         <td> <input type='text' size="12" name='codpedido1' ></td>
		         <td> <input type='text' size="12" name='codpedido2' ></td>
		         <td> <input type='text' size="12" name='codpedido3' ></td>
		         <td> <input type='text' size="12" name='codpedido4' ></td>
		         <td> <input type='text' size="12" name='codpedido5' ></td>
		    </tr>
		    <tr>
		         <td> <input type='text' size="12" name='codpedido6' ></td>
		         <td> <input type='text' size="12" name='codpedido7' ></td>
		         <td> <input type='text' size="12" name='codpedido8' ></td>
		         <td> <input type='text' size="12" name='codpedido9' ></td>
		         <td> <input type='text' size="12" name='codpedido10' ></td>
		    </tr>
		    <tr><th colspan='100%' align="center"><button id="btncargar" type="button" onclick="cargar()" title='Cargar Pedido' ><img src='./images/carga_ok.jpg' width='25' height='25' border='0'></button></th></tr>
