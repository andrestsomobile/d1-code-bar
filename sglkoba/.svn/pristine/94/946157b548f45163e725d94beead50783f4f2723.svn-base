...
<div class="TITULO"> Reportes de Inventario  <br>Saldos por Posicion </div>
 <br>
<html:form action="reportesAction.do?tipo=inventarios&reporte=saldos_posicion" method="post"  onsubmit="return validar()"> 
<table >
<%@include file="companias.jsp"%> 
<%@include file="posicion.jsp"%>  
