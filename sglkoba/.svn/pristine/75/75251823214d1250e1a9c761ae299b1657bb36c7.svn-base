...
%>
<div class="titulo">Registro Fotografico  Vehiculo: <%=clave%> </div> 
...
a.vClass:link {color: blue;} 
 ...
 <tr>
      ...
      <td nowrap="nowrap"><a href='main.jsp?app=ingreso&modulo=subirRegFotografico&clave=<%=clave%>&eliminararchivo=ok&nombrearchivo=<%=f.getName() %>'>Eliminar</a>
    </tr>
