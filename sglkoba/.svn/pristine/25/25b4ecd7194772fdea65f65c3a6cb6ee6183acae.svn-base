...
<div class="TITULO"> Reportes de Inventario  <br>Saldos por Embarque </div>
 <br>
<html:form action="reportesAction.do?tipo=inventarios&reporte=saldos_embarque" method="post" onsubmit="return validar()" > 
<html:hidden property="reporte" value="saldos_embarque"/>
<table >
