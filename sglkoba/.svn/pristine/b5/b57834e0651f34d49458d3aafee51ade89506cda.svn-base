...
<div class="titulo"> Indicador de Contenedores de Ingreso</div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=indicador_ingresos_contenedores" method="post" onsubmit="return validar()"> 
<table>
