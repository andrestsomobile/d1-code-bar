...
//valido REFERENCIA
	if( document.reportesForm.referencia.value=='') mens +='-Debe Escribir la referencia\n';
...
<div class="TITULO"> Reportes de Inventario  <br>Saldos Embarque por Referencia </div>
 <br>
<html:form action="reportesAction.do?tipo=inventarios&reporte=reporte_saldo_bl_ref" method="post" onsubmit="return validar()" > 
<html:hidden property="reporte" value="reporte_saldo_bl_ref"/>
<table >
