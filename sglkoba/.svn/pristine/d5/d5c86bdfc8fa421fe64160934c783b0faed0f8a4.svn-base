...
<div class="titulo"> Modelos por Embarque</div>

<html:form action="reportesAction.do?tipo=operaciones&reporte=modelos_embarque" method="post" onsubmit="return validar()" > 
<table >
