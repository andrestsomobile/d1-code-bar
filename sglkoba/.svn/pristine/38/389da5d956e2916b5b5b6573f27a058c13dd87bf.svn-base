...
public class entrada_locacion {
	...
	public entrada_locacion() {
		super();
	}


	public entrada_locacion(String elcodsx, String elcodentrada, String elcodlocacionorigen, String elcodlocaciondestino, String elcantidadnac, String elsaldonac, String elcantidadsnac, String elsaldosnac, String elfecha, String elpersona,String resumen) {
		super();
