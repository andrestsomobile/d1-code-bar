...
public class entradavehiculo implements java.io.Serializable {
	...
	public entradavehiculo(String evcodsx, String evcodcia, String evfecha, String evdocumento, String evestado, String resumen) {
		super();
