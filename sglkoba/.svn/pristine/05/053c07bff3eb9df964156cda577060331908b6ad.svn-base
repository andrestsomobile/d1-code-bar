...
<div class="TITULO"> Reportes de Inventario  <br>Inventario de Unidades Detallado(Excel-Kardex) </div>
 <br>
<html:form action="reportesAction.do?tipo=inventarios&reporte=inventario_unidades_detallado_excel&tipo_reporte=EXCELGENERADO" method="post"  onsubmit="return validar()"> 
<table >
<%@include file="compania.jsp"%> 
<%@include file="fecha.jsp"%>  
<input type="hidden" name="pagina" value='main.jsp?app=reportes&modulo=inventario_unidades_detallado_excel&tipo=inventarios'>  
