...
public static String getFormatedNumberForAS400(String numero400, int nDecimalesEntrada, int nDecimalesSalida, int TipoCampo, boolean simboloPorcentaje) {
	...
	double divisor = java.lang.Math.pow(10, Double.parseDouble(String.valueOf(nDecimalesEntrada)));
...
public static String getFormatedNumber(String cantidad) {
	cantidad = cantidad==null || (cantidad!=null && cantidad.equals("")) ?"0.00" : cantidad;
	return getFormatedNumber(new BigDecimal(cantidad), 2, 0, false);
}
