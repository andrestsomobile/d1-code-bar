...
<div class="titulo"> Cargar Despacho a Regionales </div> 
<table >
	<tr>
		<%@include file="compania.jsp"%> 
		<td><a href="files/distrinal/MODELODESPACHODISTRINAL.xls" download="files/distrinal/MODELODESPACHODISTRINAL.xls">Archivo modelo de Despachos de Distribucion Nacional</a>
	</tr>
</table>
</html:form>
