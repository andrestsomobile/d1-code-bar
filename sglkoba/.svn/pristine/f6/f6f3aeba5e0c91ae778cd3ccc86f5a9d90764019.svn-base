...
public class pedidovehiculo implements java.io.Serializable {
	...
	public pedidovehiculo(String pvcodsx, String pvfecha, String pvcodcia, String pvnumeropedido, String pvcodcliente, String pvcodciudaddestino, String pvdireccion, String pvestado, String resumen) {
		super();
