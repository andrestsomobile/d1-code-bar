...
<div class="titulo"> Movimientos de merancia por dia  </div>
<html:form action="reportesAction.do?tipo=operaciones&reporte=movimientos" method="post" onsubmit="return validar()" > 
<table>
<%@include file="companias.jsp"%> 
<%@include file="fechas.jsp"%> 
<%@include file="referencias.jsp"%>  
<%@include file="entrada_salida.jsp"%>  
