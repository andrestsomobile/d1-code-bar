...
public class registro_almacenamiento_detalle implements Serializable {
	...
	public registro_almacenamiento_detalle(String radecodsx, String raderegalm, String radecodentrada, String radecodreubicacion, String radeestibas, String radetiempo) {
		super();
