...
public class CopyOfbeanConnector implements Serializable {
	...
	static {
			...
			datasource.setDatabaseName("sgl_jul10");
	 ...
	 */
	public CopyOfbeanConnector() {
	
	}

public CopyOfbeanConnector(boolean modoTransaccion) {
		try { 
